...
#define OPTIMIZE_EARLY_BREAK
#define OPTIMIZE_LESS_SQRT
...
#if !defined(OPTIMIZE_EARLY_BREAK) && !defined(OPTIMIZE_LESS_SQRT) 
...
#elif defined(OPTIMIZE_EARLY_BREAK) && !defined(OPTIMIZE_LESS_SQRT)
bool intersects(Vector<T,3> origin, Vector<T,3> direction,
                   FLOAT &t, FLOAT &u, FLOAT &v, FLOAT minimum_t = INFINITY) {
    Vector<T, 3> normal =  cross_product(p2 - p1, p3  - p1);
