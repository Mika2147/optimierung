...
void measure_sqrt_time(void) {
    ...
    for (int j = 0; j < LOOP; j++) {
      for (int i = 0; i < 4 * N; i += 4) {
        ...
        #ifdef PRINT_DEBUG_SQRT_2
        std::cout << *(roots + i) << " is squareroot of " << *(floats + i) << "\n";
        std::cout << *(roots + i + 1) << " is squareroot of " << *(floats + i + 1) << "\n";
        std::cout << *(roots + i + 2) << " is squareroot of " << *(floats + i + 2) << "\n";
        std::cout << *(roots + i + 3) << " is squareroot of " << *(floats + i + 3) << "\n";
        #endif
